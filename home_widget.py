...
from PyQt5.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QToolTip, QLabel
...
class HomeWidget(QWidget):
    ...
    def update_scoreboard(self):
        # 기존에 추가된 ScoreLabel 인스턴스를 제거합니다.
        for i in reversed(range(self.scoreboard_layout.count())):
            self.scoreboard_layout.itemAt(i).widget().setParent(None)
